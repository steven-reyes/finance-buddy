    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <input
          ...
          className="bg-white/[0.06] border border-white/[0.08] rounded-lg px-3 py-2 text-sm text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      {loadingSummary ? (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="h-72 bg-white/[0.06] rounded-xl animate-pulse" />
            <div className="h-72 bg-white/[0.06] rounded-xl animate-pulse" />
          </div>
        </div>
      ...
      {insights && insights.insights && insights.insights.length > 0 && (
        <div className="glass-card rounded-2xl">
          <button
            ...
            className="w-full flex items-center justify-between px-5 py-3.5 hover:bg-white/[0.06] transition-colors rounded-2xl"
          >
            <div className="flex items-center gap-2">
              <Lightbulb size={18} className="text-yellow-400" />
              <span className="text-sm font-semibold text-gray-200">Monthly Insights</span>
              <span className="text-xs bg-white/[0.06] text-gray-400 px-2 py-0.5 rounded-full">{insights.insights.length}</span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-card rounded-2xl p-5">
          ...
          {loadingTrends ? (
            <div className="h-[280px] bg-white/[0.06] rounded-lg animate-pulse" />
        ...
        <div className="glass-card rounded-2xl p-5">
          ...
          {loadingSpending ? (
            <div className="h-[240px] bg-white/[0.06] rounded-lg animate-pulse" />
      ...
      {monthComparison && monthComparison.length > 0 && (
        <div className="glass-card rounded-2xl p-5">
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-5 text-xs text-gray-500 pb-2 border-b border-white/[0.04]">
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-5">
          ...
          <div className="flex gap-3 mt-3 ml-13">
            ...
            <button
              ...
              className="px-4 py-2 text-sm bg-white/[0.06] hover:bg-white/[0.10] text-gray-400 rounded-lg transition-colors border border-white/[0.08]"
            >
              Dismiss
            </button>
          </div>
